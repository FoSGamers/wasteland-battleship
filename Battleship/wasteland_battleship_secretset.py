...
class ControlWindow(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        # Row 0: Shot controls
        self.name_input.setMinimumWidth(110)
        self.coord_input.setMinimumWidth(90)
        self.fire_btn.setMinimumWidth(70)
        self.undo_btn.setMinimumWidth(70)
        self.reset_btn.setMinimumWidth(100)
        controls_grid.addWidget(self.name_input, 0, 0)
        controls_grid.addWidget(self.coord_input, 0, 1)
        controls_grid.addWidget(self.team_box, 0, 2)
        controls_grid.addWidget(self.fire_btn, 0, 3)
        controls_grid.addWidget(self.undo_btn, 0, 4)
        controls_grid.addWidget(self.reset_btn, 0, 5)
        # Row 1: Ship controls
        self.ship_select.setMinimumWidth(90)
        self.rotate_btn.setMinimumWidth(80)
        self.ship_team.setMinimumWidth(70)
        self.place_btn.setMinimumWidth(120)
        self.ship_entry.setMinimumWidth(70)
        self.randomize_all_btn.setMinimumWidth(120)
        self.randomize_alpha_btn.setMinimumWidth(100)
        self.randomize_omega_btn.setMinimumWidth(110)
        self.randomize_selected_btn.setMinimumWidth(120)
        controls_grid.addWidget(self.ship_select, 1, 0)
        controls_grid.addWidget(self.rotate_btn, 1, 1)
        controls_grid.addWidget(self.ship_team, 1, 2)
        controls_grid.addWidget(self.place_btn, 1, 3)
        controls_grid.addWidget(self.ship_entry, 1, 4)
        controls_grid.addWidget(self.randomize_all_btn, 1, 5)
        controls_grid.addWidget(self.randomize_alpha_btn, 1, 6)
        controls_grid.addWidget(self.randomize_omega_btn, 1, 7)
        controls_grid.addWidget(self.randomize_selected_btn, 1, 8)
        # Row 2: Game/stats controls
        self.save_log_btn.setMinimumWidth(90)
        self.export_hit_btn.setMinimumWidth(120)
        self.alpha_win_btn.setMinimumWidth(90)
        self.omega_win_btn.setMinimumWidth(100)
        self.stats_btn.setMinimumWidth(120)
        self.leaderboard_btn.setMinimumWidth(120)
        self.gm_vs_players_btn.setMinimumWidth(160)
        controls_grid.addWidget(self.save_log_btn, 2, 0)
        controls_grid.addWidget(self.export_hit_btn, 2, 1)
        controls_grid.addWidget(self.alpha_win_btn, 2, 2)
        controls_grid.addWidget(self.omega_win_btn, 2, 3)
        controls_grid.addWidget(self.win_label, 2, 4)
        controls_grid.addWidget(self.stats_btn, 2, 5)
        controls_grid.addWidget(self.leaderboard_btn, 2, 6)
        controls_grid.addWidget(self.gm_vs_players_btn, 2, 7)
